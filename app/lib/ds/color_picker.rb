module Ds
  class ColorPicker < Ds::Base
    ...
    ITEM_CLASSES = "aspect-square rounded-full cursor-pointer relative"
    INDICATOR_CLASSES = "hidden peer-checked:block rounded-full h-full w-full ring-4 ring-offset-1 ring-primary"
